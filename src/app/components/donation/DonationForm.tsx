...
const DonationForm = () => {
  ...
  const [isPaymentModalOpen, setIsPaymentModalOpen] = useState(false); // Starea pentru PaymentModal
  const [isTransferModalOpen, setIsTransferModalOpen] = useState(false); // Starea pentru TransferModal
  ...
  const handleDonationClick = () => {
    ...
    if (paymentMethod === 'Card') {
      setIsPaymentModalOpen(true); // Deschide PaymentModal
    } else if (paymentMethod === 'Transfer') {
      setIsTransferModalOpen(true); // Deschide TransferModal
    }
  };
